...
export interface Product {
  ...
  export function updateProductPrices(csvService: CsvService, products: ProductCategory[]) {
    csvService.fetchCsvData('files/ProductPrices.csv').subscribe(
      (csvData) => {
      ...
      },
      {
        ...
        products: [
          { 
            ...
            , image: 'images/training-shirt-1.png'
            , price: ''
          ...
          { 
            id: 9
            ,name: 'Training Vests'
            , image: 'images/training-vest-1.png'
            , price: ''
            ,availableSizes: ['XS', 'S', 'M', 'L', 'XL', '2XL', '3XL',]
            ,availableTypes: ['Standard']
            ,availableColors: [
          ...
          { 
            ...
            , image: 'images/training-vest-ladies-1.png'
            , price: ''
            ,availableSizes: ['XS', 'S', 'M', 'L', 'XL', '2XL', '3XL']
            ,availableTypes: ['Standard']
            ,availableColors: [
      ...
      },
      {
        ...
        products: [
          ...
          { 
            ...
            , image: 'images/signature-snapback-cap.png'
            , price: ''
            ,availableSizes: ['Standard']
            ,availableTypes: ['Standard']
            ,availableColors: [
